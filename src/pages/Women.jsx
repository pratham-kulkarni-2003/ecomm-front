...
const Women = () => {
  ...
  useEffect(()=>{
      // Fetch women's products when component mounts
          ...
          <div className='flex-1 min-w-0'>
            ...
            <div className='bg-white rounded-xl shadow-sm border border-[#e8dccf] p-6 mb-6'>
              <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
                <div>
                  <h1 className='text-3xl font-bold text-[#3d2b1f] mb-2'>Women's Collection</h1>
              ...
              <div className='bg-white rounded-xl shadow-sm border border-[#e8dccf] p-12 text-center'>
                <div className='max-w-md mx-auto'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    {search ? 
                      `No women's products match your search for "${search}"` : 
                      'No women's products match your current filters'
                    }
                  </p>
